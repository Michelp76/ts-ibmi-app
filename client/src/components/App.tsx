...
const App = () => {
  ...
  return (
    <>
      ...
      {objToInspect !== '' && (
        <code className="relative mx-auto max-w-4xl flex flex-col gap-3 h-dvh overflow-y-auto break-all bg-base-200 p-12 pt-10 text-xs shadow-md text-gray-700 bg-gray-100">
          {logsAS400 &&
